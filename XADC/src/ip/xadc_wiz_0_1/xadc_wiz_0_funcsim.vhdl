...
--               H:/ZYNQ_prj/DigitalCircuit/XADC/src/ip/xadc_wiz_0_1/xadc_wiz_0_funcsim.vhdl
-- Design      : xadc_wiz_0
...
U0: unisim.vcomponents.XADC
    generic map(
      ...
      IS_DCLK_INVERTED => '0',
      SIM_DEVICE => "7SERIES",
      SIM_MONITOR_FILE => "h:/ZYNQ_prj/DigitalCircuit/XADC/src/ip/xadc_wiz_0_1/xadc_wiz_0/simulation/functional/design.txt"
    )
    port map (
      ALM(7) => alarm_out,
